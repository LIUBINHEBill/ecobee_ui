...
export default function Leaderboard({ onBack }: LeaderboardProps) {
  ...
  return (
    <div className="min-h-screen bg-app text-app-fore p-4">
        ...
        <div className="glass rounded-2xl mb-6 overflow-hidden">
          <div className="glass-header text-white p-6">
            <div className="flex items-center justify-between">
              ...
              <FaLeaf className="text-5xl text-white/30" />
            </div>
          </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-white/70">A-Grade Eco Heroes</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="p-6">
            ...
            {leaderboardData.length === 0 ? (
              <div className="text-center py-8">
                <FaLeaf className="text-white/30 text-4xl mx-auto mb-4" />
              ...
              <div className="space-y-3">
                {leaderboardData.slice(0, 20).map((entry, index) => (
                  <div
                    ...
                    className={`flex items-center justify-between p-4 rounded-xl transition-all duration-200 glass-card-inner`}
                  >
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="text-right">
                        ...
                        <div className="text-sm text-white/70">EcoScore</div>
                      </div>
                      <div
